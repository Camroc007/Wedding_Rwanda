...
const galleryImages = [
  { src: 'https://images.unsplash.com/photo-1518621736915-f3b1c41bfd00?w=800&q=80', caption: 'Rose' },
            ...
            <Reveal delay={150} className="mt-24">
              <div className="bg-white rounded-[2rem] p-12 shadow-2xl max-w-5xl mx-auto border border-amber-100">
                ...
                <div className="bg-orange-50 rounded-2xl p-8 text-center">
                  <p className="text-gray-700 leading-relaxed mb-3"><strong>28th May – 6th June 2027</strong> — Optional participation for wedding guests who feel called to this mission of mercy.</p>

...
const T = {
  EN: {
    ...
    safariItinerary: 'We will be staying in Kigali on the 4th. The safari will pick us up on the 5th. We return in the afternoon, stay the night in Kigali, and fly back on the 6th.',
    ...
    safariBooking: 'We will cover the cost of transport but you will be required to pay the safari entrance price.',
    safariContact: 'This is separate from your RSVP. Please contact Mary or Cormac directly to register your interest.',

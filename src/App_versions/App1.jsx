// src/App.jsx
// Enhanced with: scroll-triggered fade-ins, parallax hero, floating animations,
// image zoom on hover, smooth section transitions — no extra dependencies needed.
...
// ── Swap these for local imports once you have the images ─────────────────────
...
// ── Scroll-triggered fade/slide-in hook ──────────────────────────────────────
function useReveal() {
...
// ── Zoom-on-hover image card ──────────────────────────────────────────────────
function ZoomCard({ src, alt, className, containerClass = '' }) {
  return (
...
// ── Floating animation (CSS keyframes injected once) ─────────────────────────
const floatStyle = `
  @keyframes float {
  ...
  .hero-title { animation: fadeInUp  1.1s cubic-bezier(0.22,1,0.36,1) both; }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-neutral-50 via-white to-neutral-50">
      ...
      <div className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="absolute top-8 right-8 opacity-10 z-10 float-slow">
          <Cross className="w-24 h-24 text-gray-600" />
        </div>
        <div className="absolute bottom-8 left-8 opacity-10 z-10 float">
        ...
        <div className="relative z-10 px-4 py-20 text-center max-w-6xl mx-auto space-y-16">
          ...
          <div className="space-y-12">
            ...
            <div className="hero-sub flex items-center justify-center space-x-12 py-8" style={{ animationDelay: '0.4s' }}>
          ...
          <div className="hero-quote space-y-8 py-12">
          ...
          <div className="hero-quote bg-white/60 backdrop-blur-sm rounded-3xl p-8 max-w-2xl mx-auto border border-white/80"
      ...
      <div className="relative bg-gradient-to-b from-orange-50 to-orange-100 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-40" style={{ overflow: 'hidden' }}>
          <ParallaxImg src={rwandaLandscape} alt="Rwanda mountains" className="w-full h-[120%] object-cover -mt-[10%]" strength={0.12} />
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-start">
              <div className="relative order-2 lg:order-1 space-y-8">
                <Reveal direction="left" delay={100}>
                  <ZoomCard src={rwandaLandscape} alt="Rwanda landscape" className="w-full h-80 object-cover" containerClass="rounded-[2rem] shadow-2xl" />
                </Reveal>
                <Reveal direction="left" delay={250}>
                  <ZoomCard src={missionWork} alt="Mission work with children" className="w-full h-64 object-cover" containerClass="rounded-[2rem] shadow-2xl" />
                </Reveal>
              </div>
                    ...
                    <div className="space-y-10">
                      ...
                      <div className="border-t border-gray-200 pt-8">
                        <div className="flex items-start space-x-4">
                          ...
                          <div>
                            <p className="text-gray-800 font-medium text-lg">Community Chapel of the Servos de Maria de Coração de Jesus</p>
              ...
              <div className="bg-white rounded-[2rem] p-12 shadow-2xl max-w-5xl mx-auto border border-amber-100">
                ...
                <div className="grid md:grid-cols-3 gap-8 mb-10">
                  {[
                    ...
                    { icon: Stethoscope,   title: 'Visiting the Sick',   desc: "Bring comfort and care to those in hospitals, sharing God's love through acts of compassion." },
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-16">
          <Reveal>
            <div className="flex justify-center items-center space-x-8">
              <Star className="w-5 h-5 text-blue-500 float" />
              <div className="w-24 h-px bg-gradient-to-r from-transparent via-blue-400 to-transparent" />
              <Cross className="w-8 h-8 text-blue-600 float-slow" />
          ...
          <Reveal delay={150}>
            ...
            <p className="text-2xl text-gray-700 font-light mt-4">for our Wedding Celebration</p>
          </Reveal>
          <Reveal delay={300}>
      ...
      <div className="relative bg-gradient-to-b from-slate-50 to-slate-100 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-50" style={{ overflow: 'hidden' }}>
          <ParallaxImg src={portugalVillage} alt="Portuguese architecture" className="w-full h-[120%] object-cover -mt-[10%]" strength={0.1} />
            ...
            <div className="grid lg:grid-cols-2 gap-20 items-center">
              ...
              <Reveal direction="right" delay={200}>
                <div className="relative">
                  <ZoomCard
                    src={portugalVillage}
                    alt="Torre de Dona Chama, Portugal"
                    className="w-full h-[28rem] object-cover"
                    containerClass="rounded-[2rem] shadow-2xl"
                  />
                  <div className="absolute -bottom-8 -right-8 w-32 h-32 bg-blue-100 rounded-full opacity-70 float" />
                  <div className="absolute -top-8 -left-8 w-20 h-20 border-2 border-blue-200 rounded-full opacity-80 float-slow" />
                  <div className="absolute top-4 right-4 opacity-60 float">
      ...
      <div className="relative py-32 px-4 overflow-hidden bg-white">
        <div className="relative z-10 max-w-6xl mx-auto">
          <Reveal className="text-center space-y-10 mb-20">
            ...
            <p className="text-2xl text-gray-600 font-light max-w-3xl mx-auto">Join us for this unique celebration of love and faith</p>
          </Reveal>
          ...
          <div className="grid md:grid-cols-2 gap-16">
            {[
              ...
              {
                color: 'blue', title: 'Portugal',
                items: [
                  ['Airport', 'Porto Airport'],
                  ['Dates', 'TBC'],
                  ['RSVP', 'Please RSVP by 1st August 2026. Guests added to WhatsApp to co-ordinate flights, itinerary and accommodation.'],
                ],
                note: 'Experience the beauty of Northern Portuguese culture and cuisine',
              },
            ].map(({ color, title, items, note }, i) => (
              <Reveal key={title} direction={i === 0 ? 'left' : 'right'} delay={i * 150}>
                <div
                  className="bg-white rounded-[2rem] p-16 shadow-2xl border border-gray-100 relative overflow-hidden"
                  style={{ transition: 'box-shadow 0.3s ease, transform 0.3s ease' }}
                  onMouseEnter={e => { e.currentTarget.style.boxShadow = '0 30px 60px rgba(0,0,0,0.12)'; e.currentTarget.style.transform = 'translateY(-4px)'; }}
                ...
                >
                  ...
                  <div className="relative z-10">
                    <h3 className={`text-3xl font-thin text-${color}-900 mb-10`}>{title}</h3>
                    <div className="space-y-8 text-gray-700">
                      {items.map(([label, value]) => (
                        <div key={label} className="flex items-start space-x-6">
                          <div className={`w-3 h-3 bg-${color}-500 rounded-full mt-2 shrink-0`} />
                          <div>
                      ...
                      <div className={`bg-${color}-50 rounded-2xl p-6 mt-8`}>
                        <p className={`text-${color}-800 italic text-lg`}>{note}</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center space-y-16">
          <Reveal>
            <div className="flex items-center justify-center space-x-6">
              ...
              <Camera className="w-10 h-10 text-rose-600 float" />
              <Cross className="w-8 h-8 text-rose-500 float-slow" />
              <div className="w-16 h-px bg-rose-400" />
            </div>
          </Reveal>
          <Reveal delay={150}><h3 className="text-4xl font-thin text-gray-800">Sacred Memories & Photography</h3></Reveal>
          <Reveal delay={250}>
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-12 max-w-4xl mx-auto shadow-2xl">
              <p className="text-gray-700 leading-relaxed text-xl mb-8">
                ...
                Portugal will welcome your joyful participation in capturing memories.
              </p>
      ...
      <div className="py-32 px-4 bg-gradient-to-b from-rose-50 via-white to-rose-50">
        <div className="max-w-5xl mx-auto text-center space-y-16">
          ...
          <Reveal delay={150}><h3 className="text-4xl font-thin text-gray-800">Gifts of Love & Service</h3></Reveal>
          <Reveal delay={250}>
            <div className="bg-white rounded-3xl p-16 shadow-2xl max-w-4xl mx-auto border border-rose-100">
              <div className="space-y-10">
                <div className="flex justify-center mb-8">
                  <HandHeart className="w-12 h-12 text-rose-500 float" />
                </div>
        ...
        <div className="max-w-6xl mx-auto text-center space-y-16">
          <Reveal>
            <div className="flex items-center justify-center space-x-6">
              ...
              <Flower2 className="w-10 h-10 text-gray-700 float-slow" />
              <Cross className="w-8 h-8 text-gray-600 float" />
              <div className="w-20 h-px bg-gray-500" />
            </div>
          </Reveal>
          <Reveal delay={100}>
          ...
          <div className="grid md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            {[
              { color: 'amber', title: 'Portuguese domiciled & all other guests', email: 'alvesmary98@gmail.com',  phone: '+44 7729 361640' },
              { color: 'blue',  title: 'Irish domiciled & all other guests',      email: 'comckennaa@gmail.com',   phone: '+353 851094610' },
            ].map(({ color, title, email, phone }, i) => (
              <Reveal key={title} direction={i === 0 ? 'left' : 'right'} delay={i * 150}>
                <div
                  className="bg-white rounded-[2rem] p-16 shadow-2xl border border-gray-100 relative overflow-hidden"
                  style={{ transition: 'transform 0.3s ease, box-shadow 0.3s ease' }}
                  onMouseEnter={e => { e.currentTarget.style.transform = 'translateY(-6px)'; e.currentTarget.style.boxShadow = '0 30px 60px rgba(0,0,0,0.12)'; }}
                  onMouseLeave={e => { e.currentTarget.style.transform = ''; e.currentTarget.style.boxShadow = ''; }}
                >
                  <div className={`absolute top-0 right-0 w-32 h-32 bg-${color}-50 rounded-full -translate-y-16 translate-x-16`} />
                  <div className="relative z-10 space-y-8">
                    <h4 className={`text-3xl font-thin text-${color}-900`}>{title}</h4>
      ...
      <div className="py-24 px-4 bg-white border-t border-gray-200">
        <div className="max-w-4xl mx-auto text-center space-y-12">
          <Reveal>
            <div className="flex justify-center items-center space-x-8">
              <div className="w-4 h-4 bg-amber-400 rounded-full float" />
              <Cross className="w-8 h-8 text-rose-500 float-slow" />
              <div className="w-5 h-5 bg-rose-500 rounded-full float" />
              <Cross className="w-8 h-8 text-rose-500 float-slow" />
              <div className="w-4 h-4 bg-blue-400 rounded-full float" />
            </div>
          </Reveal>
          <Reveal delay={150}>
          ...
          <Reveal delay={250}>
            ...
            <p className="text-gray-500 mt-6">We are blessed to share these sacred moments with you!</p>
          </Reveal>
          <Reveal delay={350}>
            <div className="flex justify-center space-x-4 pt-12">
              ...
              <Cross className="w-8 h-8 text-rose-500 mt-2 float" />
              <div className="w-1 h-16 bg-gradient-to-b from-rose-500 to-transparent" />
              <div className="w-1 h-12 bg-gradient-to-b from-rose-400 to-transparent" />
            </div>
          </Reveal>
